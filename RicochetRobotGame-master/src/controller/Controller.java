	...
	public class Controller implements KeyListener {
		...
		public Controller(Grille g, ArrayList<Pions> pions, Draw draw){
			...
			this.draw = draw;
			this.setRobot();
			this.draw.setWin("   Seleziona Robot : Robot " + this.robot.getColor());
		}
		...
		public void keyPressed(KeyEvent e) {
			...
			if(!this.gameOver) {
				...
				draw.setWin("   Seleziona Robot : Robot " + this.robot.getColor());
			}		 
		...
		public void keyReleased(KeyEvent e){
			...
			try {
				if(!this.gameOver) {
					...
					this.gameOver();
					if(this.gameOver) {
						this.draw.setWin("Hai vinto !!! Premi\"Entrer\"per ricominciare.");
					}
				} 
				this.draw.update();
			} catch (Exception ex) {
