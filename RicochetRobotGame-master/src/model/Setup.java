...
public class Setup {
	...
	public void setup() {
		...
		// INIT PIONS
		String [] colors = {"rosso", "verde", "giallo", "blu"};
		...
		switch(jeu) {
			case 0:
				switch (this.randomGenerator.nextInt(4)) {
					case 0: pion = new Pions(9, 10, "giallo", "target"); break;
					case 1: pion = new Pions(3, 12, "verde", "target"); break;
					case 2: pion = new Pions(6, 3, "blu", "target"); break;
					case 3: pion = new Pions(14, 5, "rosso", "target"); break;
					default: break;
				}
				break;
			case 1:
				switch (this.randomGenerator.nextInt(4)) {
					case 0: pion = new Pions(4, 6, "giallo", "target"); break;
					case 1: pion = new Pions(9, 2, "verde", "target"); break;
					case 2: pion = new Pions(9, 10, "blu", "target"); break;
					case 3: pion = new Pions(1, 11, "rosso", "target"); break;
					default: break;
				}
				break;
			case 2:
				switch (this.randomGenerator.nextInt(4)) {
					case 0: pion = new Pions(14, 6, "giallo", "target"); break;
					case 1: pion = new Pions(9, 5, "verde", "target"); break;
					case 2: pion = new Pions(4, 9, "blu", "target"); break;
					case 3: pion = new Pions(11, 13, "rosso", "target"); break;
					default: break;
				}
				break;
			default: break;
